...
if( isset($_POST['submit']) ){
        ...
        if(!empty(trim($nama)) && !empty(trim($telepon)) && !empty(trim($username)) && !empty(trim($email)) && !empty(trim($password)) && !empty(trim($repass))){
            ...
            if($password == $repass){
                ...
                if( cek_nama($nama,$con) == 0 ){
                    ...
                    $query = "INSERT INTO `registrasi` (username,nama, telepon, email, password ) VALUES ('$username','$nama', '$telepon', '$email','$password')";
    ...
    function cek_nama($username,$con){
        ...
        $query = "SELECT * FROM `registrasi` WHERE username = '$nama'";
...
<body>
  ...
  <header style="background-color: #e9dcd0">
    <div class="container1" >
      <h1><a style="font-size: 36px" href="homepage.html">High N Jar</a></h1>
      <ul>
        ...
        <section class="container-fluid mb-4">
            ...
            <section class="col-12 col-sm-6 col-md-4">
                <form class="form-container" action="register.php" method="POST">
                    <br><br><br><br><br><center></b><h6 class="text-center font-weight-bold"> Sign-Up </h6></center>
                    <?php if($error != ''){ ?>
        ...
        <footer>
    <div >
      <small>Copyright 2021 - High N Jar. All Rights Reserved.</small>
    </div>
  </footer>
